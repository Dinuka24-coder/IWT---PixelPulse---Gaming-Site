...
<li id="logo"><a href="../IWT Project/Register.html"> <img src="resources(src)/images/profile.png" width="35px" height="35px"></a></li>	
	...
	<button type="submit" class="lbtn"> <a href="../Register_Dinuka/RegisterAdmin.php"> Register Admin </a></button>
	
	<button type="submit" class="lbtn"> <a href="../FA_Pramod/faqphp.php"> FAQ Admin </a></button>
	
	<button type="submit" class="lbtn"> <a href="../Gamestore_Chamo/cart2.php"> Cart Admin </a></button>
	
	<button type="submit" class="lbtn"> <a href="../Feed_Dineni/addfeeds.php"> Feedback Admin </a></button>
	
	<button type="submit" class="lbtn"> <a href="../Support(updated)_Dineni/support1.php"> Support Admin </a></button>

...
<td><a href='editrecord.php?id=$row[Reg_ID]&fname=$row[FirstName]&lname=$row[LastName]&dob=$row[DOB]&country=$row[Country]&gender=$row[Gender]&mail=$row[Email]&pnum=$row[Pnumber]&des=$row[Description]&pass=$row[Password]&cpass=$row[C_password]'>Edit</a></td>
